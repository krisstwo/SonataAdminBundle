...
class CRUDController implements ContainerAwareInterface
{
    ...
    public function listAction()
    {
        ...
        return $this->renderWithExtraParams($template, [
            ...
            'form' => $formView,
            'datagrid' => $datagrid,
            'csrf_token' => $this->container->get('sonata.admin.util.csrf.manager')->getCsrfToken('sonata.batch'),
    ...
    public function deleteAction($id) // NEXT_MAJOR: Remove the unused $id parameter
    {
        ...
        if (Request::METHOD_DELETE === $request->getMethod()) {
            ...
            $this->container->get('sonata.admin.util.csrf.manager')->validateCsrfToken('sonata.delete');
        ...
        return $this->renderWithExtraParams($template, [
            'object' => $object,
            'action' => 'delete',
            'csrf_token' => $this->container->get('sonata.admin.util.csrf.manager')->getCsrfToken('sonata.delete'),
        ], null);
    }
    ...
    public function batchAction()
    {
        ...
        // check the csrf token
        $this->container->get('sonata.admin.util.csrf.manager')->validateCsrfToken('sonata.batch');
...
//        return \is_array($aclUsers) ? new \ArrayIterator($aclUsers) : $aclUsers;
    ...
    {
        return $this->container->get('sonata.admin.util.csrf.manager')->validateCsrfToken($intention);
    }
    ...
    {
        return $this->container->get('sonata.admin.util.csrf.manager')->getCsrfToken($intention);
    }
